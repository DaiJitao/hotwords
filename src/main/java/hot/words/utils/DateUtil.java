...
public class DateUtil {
     ...
     *
     * @param type 1:
     * @return 20200305101113
     */
    public static String getCurrentTime2(String type) {
        Date date = new Date();
        // 小写的hh取得12小时，大写的HH取的是24小时
        if (type.equals("1")) {
...
//        System.out.println(getCurrentTime2("2").length());
//        System.out.println("201909222359".length());
//    }
